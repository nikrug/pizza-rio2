...
module.exports = configure(function(ctx) {
  return {
    ...
    css: [
      ...
      '../app/styles/quasar.variables.scss',
      '../app/styles/app.scss'
    ],
    ...
    build: {
      ...
      env: {
        Q_NODE_ENV: process.env.Q_NODE_ENV,
      ...
      chainWebpack(config) {
        ...
        config.resolve.alias
          .set('boot',path.resolve(__dirname, 'src/app/boot'))
        ...
        config.plugin('DefinePlugin')
          .use(webpack.DefinePlugin, [{
            '__IS_DEV__': process.env.Q_NODE_ENV === 'development',
            '__IS_PROD__': process.env.Q_NODE_ENV === 'production',
          }]);
        // config.plugin('stylelint-webpack-plugin')
        //   .use(StylelintPlugin)
        //   .tap(args => [{ configFile: './.stylelintrc.mjs' }, ...args]);
